...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <!-- Font Awesome-->
    @includeIf('layouts.backend.admin-dashboard.partials.css')
</head>
<body>
    <!-- Loader starts-->
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
        ...
        <div class="page-body">
            <!-- Container starts-->
            @includeIf('layouts.backend.admin-dashboard.partials.card')
            @yield('content')
    ...
    @includeIf('layouts.backend.admin-dashboard.partials.js')
