...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <!-- Font Awesome-->
    @includeIf('layouts.backend.customer.partials.css')
</head>
<body>
    <!-- Loader starts-->
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
        <!-- Page Header Start-->
        @includeIf('layouts.backend.customer.partials.header')
        
        <div class="page-body-wrapper sidebar-icon">
            @includeIf('layouts.backend.customer.partials.sidebar')
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 footer-copyright">
                        <p class="mb-0">Copyright 2023-24 ©BazarBag All rights reserved.</p>
                    </div>
                    <div class="col-md-6">
    ...
    @includeIf('layouts.backend.customer.partials.js')
</body>
