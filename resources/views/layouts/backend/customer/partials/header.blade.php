<div class="page-main-header">
    <div class="main-header-right row m-0">
        <div class="main-header-left">
            ...
            @else
                <div class="logo-wrapper"><a href="{{ route('customer.dashboard', ['name' => auth()->user()->name]) }}"><img class="img-fluid"
                            src="{{-- {{ asset('assets/images/lap-attendance/logo/Logo Black.png') }} --}}" alt=""></a>
                    {{-- <span style="color:#262626; padding" class="mx-4"><b>Admin Panel</b></span> --}}
                </div>
                <div class="dark-logo-wrapper"><a href="{{ route('customer.dashboard', ['name' => auth()->user()->name]) }}"><img class="img-fluid"
                            src="{{-- {{ asset('assets/images/lap-attendance/logo/logo.png') }} --}}" alt=""></a>
                </div>
            @endif
