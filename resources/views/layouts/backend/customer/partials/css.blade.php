...
<link rel="stylesheet" type="text/css" href="{{ asset('backend/assets/css/custom-datatable.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('backend/assets/css/custom-rating.css') }}">
...
<link href="{{ asset('backend/assets/css/froala_editor.pkgd.min.css') }}" rel="stylesheet" type="text/css" />
